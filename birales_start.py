...
if __name__ == '__main__':
    ...
    p = OptionParser()
    p.set_usage('birales_start.py <ROACH_HOSTNAME_or_IP> [options]')
    ...
    gbe_freq_name       = base_conf['gbe-0']
    gbe_freq_dest_ip    = base_conf['gbe-0_dest_ip']
    gbe_freq_dest_port  = base_conf['gbe-0_dest_port']
    gbe_freq_pkt_len    = base_conf['gbe-0_pkt_len']
